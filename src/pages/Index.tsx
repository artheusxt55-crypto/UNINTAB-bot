...
export default function Index() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      let contexto = `AURA IA -
            INTELIGÊNCIA ACADÊMICA | ID: ${idParaBusca}
      ...
      <AnimatePresence>
        {showVoiceOrb && (
          ...
          >
            ...
            <button onClick={() => setShowVoiceOrb(false)} className="mt-8 p-4 rounded-full bg-red-500/20 text-red-500">
              <MicOff size={24} />
            </button>
          </motion.div>
        )}
